...
$formmailobj->SetErrorEmail("Marilyn Sudbeck<marilyn@nimbusqb.com>");

$formmailobj->SetDebugMode(false);

$formmailobj->SetFromAddress("marilyn@nimbusqb.com");
...
$confirmpage =  new FM_ConfirmPage(sfm_readfile("./templ/contact_us_confirm_page.txt"));

$confirmpage->SetButtonCode(sfm_readfile("./templ/contact_us_confirm_button_code.txt"),sfm_readfile("./templ/contact_us_edit_button_code.txt"),sfm_readfile("./templ/contact_us_print_button_code.txt"));

$confirmpage->SetExtraCode(sfm_readfile("./templ/contact_us_confirm_ie6_png_fix.txt"));

$formmailobj->addModule($confirmpage);
...
$data_email_sender->AddToAddr("Marilyn Sudbeck<marilyn@nimbusqb.com>");
